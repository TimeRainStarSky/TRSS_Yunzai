...
pacman -Syu --noconfirm --needed --overwrite "*" curl dialog git tmux perl micro ranger fastfetch unzip fish btop htop nethogs ncdu ack fd fzf bat catimg||abort "依赖安装失败"
